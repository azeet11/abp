...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f2a3b876-9253-4eec-9830-eb3e18c99d88
```

> `f2a3b876-9253-4eec-9830-eb3e18c99d88` is the password of the certificate, you can change it to any password you want.
